...
public class PatientController {
    ...
    public ResponseEntity<Map<String, Object>> createPatient(@Valid @RequestBody Patient patient) {
        ...
        if (patientService.createPatient(patient) == 0) {
    ...
    public ResponseEntity<Map<String, Object>> getPatientAppointmentForUser(@PathVariable Long id, @PathVariable String user,
    ...
    public ResponseEntity<Map<String, Object>> filterPatientAppointment(@PathVariable String condition, @PathVariable String name,
                                                                         @PathVariable String token) {
        return service.filterPatientAppointment(condition, name, token);
    }
